...
Page({
  ...
  getDetail(e) {
    ...
    wx: wx.navigateTo({
      url: '/views/orderList/listMore/listMore?id=' + e.currentTarget.dataset.orderid,
  ...
  getReturn(e) {
    wx: wx.navigateTo({
      url: '/views/orderList/returnList/returnList?id=' + e.currentTarget.dataset.orderid,
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
  ...
  getComment(e){
    ...
    // let id = e.currentTarget.dataset.pid ? e.currentTarget.dataset.pid : ''
    wx: wx.navigateTo({
      url: '/views/personal/myTry/tryComment/tryComment?id=' + e.currentTarget.dataset.orderid + '&type=' + e.currentTarget.dataset.type,
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
  ...
  onPullDownRefresh: function () {
    ...
    let data = {
      url: '/mobile/order/myOrder',
      data: { page: 1, rows: 10, memberId: app.userId, type: 2, status: statusNew },
      callback: function (res) {
        _self.setData({
